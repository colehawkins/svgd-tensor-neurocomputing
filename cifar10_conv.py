...
from utils import get_normal_prior,show_variance_and_weights,count_removed_params,get_svgd_update,make_particles,get_tt_prior,create_posterior_loss,get_mean_log_likelihood, make_batch_dict
...
fc2 = BayesKerasDense([32,16],[2,5],tt_rank=fc_tt_rank,low_rank_init=low_rank_init)
